...
export default async function ProductsPage({ searchParams }: { searchParams: Promise<{ category?: string }> }) {
  ...
  const [categories, visibleProducts] = await Promise.all([
    getCategories(),
    getProducts({ categorySlug: selected })
  ]);
  ...
  return (
    <section className="section-pad bg-slate-50">
      <div className="container-page">
        <SectionHeading
          eyebrow="Sản phẩm"
          title="Catalogue sản phẩm B2B"
          description="Lọc theo danh mục để đại lý và nhà thầu nhanh chóng tìm đúng dòng rèm cần tư vấn."
        />
