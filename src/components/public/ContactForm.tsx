...
export function PartnerRegistrationForm({ categories, formLocation = "public" }: { categories: Category[]; formLocation?: string }) {
  ...
  async function submit(formData: FormData) {
    ...
    const payload = {
      ...
      interestedProducts: formData.getAll("interestedProducts").map(String),
