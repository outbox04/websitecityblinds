...
import { getPost, posts } from "@/lib/utils/sample-data";
...
// Post detail sanitizes rich CMS HTML before rendering to reduce XSS risk.
  ...
  return (
    <article className="section-pad bg-white">
      ...
      <div className="container-page max-w-3xl">
        <div className="mb-3 text-sm font-bold uppercase text-city-700">{post.categorySlug}</div>
